...
@section('content')
    <section class="menu" id="menu">
        ...
        <div class="box-container">
            <a href="#" class="box">
                <img src="{{ asset('coffee-shop/image/menu-1.png') }}" alt="">
                <div class="content">
            ...
            <a href="#" class="box">
                <img src="{{ asset('coffee-shop/image/menu-2.png') }}" alt="">
                <div class="content">
                    <h3>our special coffee</h3>
            ...
            <a href="#" class="box">
                <img src="{{ asset('coffee-shop/image/menu-3.png') }}" alt="">
                <div class="content">
                    <h3>our special coffee</h3>
            ...
            <a href="#" class="box">
                <img src="{{ asset('coffee-shop/image/menu-4.png') }}" alt="">
                <div class="content">
                    <h3>our special coffee</h3>
            ...
            <a href="#" class="box">
                <img src="{{ asset('coffee-shop/image/menu-5.png') }}" alt="">
                <div class="content">
                    <h3>our special coffee</h3>
            ...
            <a href="#" class="box">
                <img src="{{ asset('coffee-shop/image/menu-6.png') }}" alt="">
                <div class="content">
                    <h3>our special coffee</h3>
